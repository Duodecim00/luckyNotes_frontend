...
const HAader2 = ({ navigation }) => {
    ...
    return( 
<View style={{ backgroundColor: COLORS.contras2, justifyContent: "space-between" ,flexDirection: "row",alignItems: "center",height:50, borderBottomColor:COLORS.terceary, borderBottomWidth: 1,}}>

<TouchableOpacity onPress={handleMAILPress}>
<Ionicons style={{marginVertical:5}}
name="chevron-back-outline" size={40}                
